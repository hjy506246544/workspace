...
/** 
 * DAO for table "CURTAIN_ENTITY".
*/
public class CurtainEntityDao extends AbstractDao<CurtainEntity, Long> {

    public static final String TABLENAME = "CURTAIN_ENTITY";

    /**
     * Properties of entity CurtainEntity.<br/>
    ...
    */
    ...
    public CurtainEntityDao(DaoConfig config) {
        super(config);
    }
    
    public CurtainEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CURTAIN_ENTITY\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CURTAIN_ENTITY\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CurtainEntity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CurtainEntity readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CurtainEntity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(CurtainEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(CurtainEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
