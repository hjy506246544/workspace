 ...
 *
 */
public class Curtain_GridViewAdapter extends BaseAdapter {
	private List listitem;
	private Context context;
	public Curtain_GridViewAdapter(Context context,List listitem){
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if(view==null){
			...
			view=LayoutInflater.from(parent.getContext()).inflate(R.layout.curtain_gridview, null);
