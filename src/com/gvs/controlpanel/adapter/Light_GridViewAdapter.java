 ...
 *
 */
public class Light_GridViewAdapter extends BaseAdapter {
	private MainActivity activity;
	private List listitem;
	private Context context;
	public Light_GridViewAdapter(Context context,List listitem){
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if(view==null){
			...
			view=LayoutInflater.from(parent.getContext()).inflate(R.layout.gridview2, null);
