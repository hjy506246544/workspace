 ...
 * 2016-6-2
 */
public class MainThreeActivity extends FragmentActivityBase {
    ...
    private void initData() {
		...
		gridViewAdapter=new Mainthree_GridViewAdapter(MainThreeActivity.this,listitem);
		...
		*/
		listgv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				//灯光
				if(position==0){
					Intent intent  = new Intent(MainThreeActivity.this,LightActivity.class);
					...
					//背景音乐
					Intent intent6  = new Intent(MainThreeActivity.this,BgMusicActivity.class);
					startActivity(intent6);
				}else if (position==6) {
					//场景
					Intent intent7  = new Intent(MainThreeActivity.this,SceneActivity.class);
					startActivity(intent7);
				}else if (position==7) {
					//安防监控
					Intent intent8  = new Intent(MainThreeActivity.this,SecurityMonitorActivity.class);
					startActivity(intent8);
				}else if (position==8) {
					//设置按钮
					Intent intent = new Intent(MainThreeActivity.this,SetActivity.class);
					startActivity(intent);
				}
			}
		});
	...
	private void showCurtainDialogTip() {
	    ...
	    sSwitch.setOnStateChangedListener(new OnStateChangedListener(){
            ...
            public void onStateChanged(boolean state) {
                if(true == state)
                {
                    Toast.makeText(MainThreeActivity.this, "开关已打开", 1000).show();
                }
                else
                {
                    Toast.makeText(MainThreeActivity.this, "开关已关闭", 1000).show();
                }
            }
	    ...
	    minusib.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		        if(wd>16){
					...
					ToastUtils.show(MainThreeActivity.this, "超过最低温度了！");
				}
			}
		});
	    ...
	    jiaib.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		        if(wd <32){
					...
					ToastUtils.show(MainThreeActivity.this, "超过最高温度了！");
				}
			}
		});
...
//    	dsjll = (LinearLayout) findViewById(R.id.dsjll);
    ...
    protected void onResume() {
    	...
    	//for(int i=0; i<layouts.length; i++){
    		...
    		mSettingManager=new SkinSettingManager(MainThreeActivity.this,listgv);
