		...
		*/
		listgv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				//灯光
				if(position==0){
					Intent intent  = new Intent(MainTwoActivity.this,LightActivity.class);
					...
					//背景音乐
					Intent intent6  = new Intent(MainTwoActivity.this,BgMusicActivity.class);
					startActivity(intent6);
				}else if (position==6) {
					//场景
					Intent intent7  = new Intent(MainTwoActivity.this,SceneActivity.class);
					startActivity(intent7);
				}else if (position==7) {
					//安防监控
					Intent intent8  = new Intent(MainTwoActivity.this,SecurityMonitorActivity.class);
					startActivity(intent8);
				}else if (position==8) {
					//设置按钮
					Intent intent = new Intent(MainTwoActivity.this,SetActivity.class);
					startActivity(intent);
				}
			}
		});
	...
	public void showCurtainDialogTip() {
	    ...
	    sSwitch.setOnStateChangedListener(new OnStateChangedListener(){
            ...
            public void onStateChanged(boolean state) {
                if(true == state)
                {
                    Toast.makeText(MainTwoActivity.this, "开关已打开", 1000).show();
                }
                else
                {
                    Toast.makeText(MainTwoActivity.this, "开关已关闭", 1000).show();
                }
            }
	    ...
	    minusib.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		        if(wd>16){
					...
					ToastUtils.show(MainTwoActivity.this, "超过最低温度了！");
				}
			}
		});
	    ...
	    jiaib.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		        if(wd <32){
					...
					ToastUtils.show(MainTwoActivity.this, "超过最高温度了！");
				}
			}
		});
