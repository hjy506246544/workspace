...
//	}
	...
	private void doDisplay(View imageView, String uri, BitmapDisplayConfig displayConfig,boolean isRound) {
		...
		if (bitmap != null) {
			viewSetImage(imageView, bitmap,displayConfig);
...
//			}
		...
		protected void onPostExecute(Bitmap bitmap) {
			...
			if(imageViewReference!=null){
				...
				if (bitmap != null && imageView != null) {
					mConfig.displayer.loadCompletedisplay(imageView,bitmap,displayConfig, mFinalBitmap);			
				}else if(bitmap == null && imageView!=null ){
					mConfig.displayer.loadFailDisplay(imageView, displayConfig.getLoadfailBitmap(),mFinalBitmap);
				}
			}else{
	...
	public void viewSetImage(View view, Bitmap bitmap,BitmapDisplayConfig displayConfig) {
